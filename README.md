...
This project was developed through individual experimentation of embedded systems, wireless telemetry, IMU motion processing, and real-time visulization with help from multiple guides noted in the acknowledgements section. 
...
The transmitter module collects telemetry data by compiling the MPU6050's YawPitchRoll values into an integer array to keep packet sizes small and transmissions few. It then utilizes the RF24 library to collapse the packet's transmission into a radio.write() command, which fully sends the YawPitchRoll array according to the specific address and packet size. 
